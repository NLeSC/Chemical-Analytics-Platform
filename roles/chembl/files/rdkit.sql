...
-- Below is borrowed from https://raw.githubusercontent.com/chembl/mychembl/master/indexes.sql and http://rdkit.org/docs/Cartridge.html#loading-chembl
...
-- Caused segfault of postgres in rdkit.so
